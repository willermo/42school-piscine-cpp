...
/*   Updated: 2023/12/20 13:56:07 by doriani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name)
    ...
    std::cout << LIGHT_GREY << "ClapTrap " << this->getName()
              << " has been created." << RESET << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap &player) {
    *this = player;
    std::cout << LIGHT_GREY << "ClapTrap " << name
...
ClapTrap::operator=(const ClapTrap &player) {
    ...
    std::cout << LIGHT_GREY << "ClapTrap " << name << " has been copied"
              << RESET << std::endl;
    return *this;
}
